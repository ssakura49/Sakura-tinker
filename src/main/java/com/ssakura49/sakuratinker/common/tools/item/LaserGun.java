...
import static com.ssakura49.sakuratinker.common.tools.capability.ForgeEnergyCapability.getEnergy;
import static com.ssakura49.sakuratinker.common.tools.capability.ForgeEnergyCapability.setEnergy;
...
public class LaserGun extends ModifiableItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if ((!tool.isBroken() && toolData.contains(ENERGY_KEY, 3) || creative) && !level.isClientSide()) {
            boolean hasEnergy = toolData.getInt(ENERGY_KEY) >= 500;
